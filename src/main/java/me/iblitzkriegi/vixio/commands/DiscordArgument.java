...
public class DiscordArgument<T> {
    ...
    @Nullable
    public static <T> DiscordArgument<T> newInstance(@Nullable final String name, final ClassInfo<T> type, final @Nullable String def, final int index, final boolean single, final boolean forceOptional) {
        ...
        return new DiscordArgument<T>(name, d, type, single, index, def != null || forceOptional);
    }
