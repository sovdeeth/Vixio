...
public class EvtEditMessage extends BaseEvent<MessageUpdateEvent> {

    static {
        BaseEvent.register("guild message edited",
                        EvtEditMessage.class, GuildMessageEditEvent.class, "(guild|server) message edit[ed]")
    ...
    @Override
    public boolean check(MessageUpdateEvent e) {
        return true;
    }

    public class GuildMessageEditEvent extends SimpleVixioEvent<MessageUpdateEvent> {
    }
