...
public class ExprArgument extends SimpleExpression<Object> {
    static {
        ...
        Vixio.getInstance().registerExpression(ExprArgument.class, Object.class, ExpressionType.SIMPLE,
    ...
    public boolean init(final Expression<?>[] exprs, final int matchedPattern, final Kleenean isDelayed, final ParseResult parser) {
        ...
        final List<DiscordArgument<?>> currentArguments = DiscordCommandFactory.getInstance().currentArguments;
